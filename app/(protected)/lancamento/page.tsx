...
export default async function ProductionPage() {
  ...
  const [profile, services, sectors, links, collaborators, indicators] = await Promise.all([
    supabase.from("profiles").select("service_id,role").eq("user_id", user!.id).single(),
